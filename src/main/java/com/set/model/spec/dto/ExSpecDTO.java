...
public class ExSpecDTO implements Serializable {
    ...
    public ExSpecDTO(int charNo, int specNo, int specSk1, int specSk2, int specSk3, String specWeapon, String specArtifactFlower, String specArtifactPlume, String specArtifactSands, String specArtifactGoblet, String specArtifactCirclet, int specHp, int specDef, int specAfk, int specEm, double specEr, double specCr, double specCdmg, String specEtc, String specEtc2) {
        this.charNo = charNo;
        this.specNo = specNo;
